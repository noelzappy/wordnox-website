...
const CommingSoon = () => {
  return (
    <>
      <Head>
        <title>
          Comming Soon || Keystroke Creative Agency Bootstrap 5 Template
        </title>
      </Head>
          ...
          <div className="shape-wrapper">
            ...
            <div className="shape shape-04">
              <Image
                width={670}
                height={106}
                src="/images/shape/comming-01.svg"
                alt="Shape Images"
              />
            </div>
            <div className="shape shape-05">
              <Image
                width={329}
                height={550}
                src="/images/shape/comming-soon.svg"
                alt="Shape Images"
              />
            </div>
          </div>
