  ...
  return (
    <Layout title={portfolio.title}>
      <main className="page-wrapper">
                    ...
                    <span className="sub-title extra04-color">
                      {portfolio.categories?.map((category, categoryIndex) => (
                        <span key={`category-${categoryIndex}`}>
                          {category}{" "}
                          {categoryIndex !== portfolio.categories.length - 1
                            ? ", "
                            : ""}
                        </span>
                      ))}
                ...
                <div className="portfolio-inner-details">
                  ...
                  >
                    <div className="card">
                      ...
                      >
                        <div className="card-body">{portfolio.strategy}</div>
                      </div>
                    </div>
                    ...
                    <div className="card">
                      ...
                      <div
                        ...
                        data-bs-parent="#accordion"
                      >
                        <div className="card-body">{portfolio.design}</div>
                      </div>
                    </div>
                    ...
                    <div className="card">
                      ...
                      <div
                        ...
                        data-bs-parent="#accordion"
                      >
                        <div className="card-body">{portfolio.development}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {isWindow && <VideoPlayer url={portfolio.videoUrl} />}
      </main>
    </Layout>
  );
};
